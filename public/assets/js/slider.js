(function($) {
    ...
    $(document).ready(function() {
        ...
        $("#slider-limit").Link('lower.html').to($('#slider-limit-value-min'))
        $("#slider-limit").Link('upper.html').to($('#slider-limit-value-max'));
        ...
        $("#slider-tooltips").Link('lower.html').to('-inline-<div class="tooltip fade top in" style="top: -33px;left: -14px;opacity: 0.7;"></div>', function(value) {
            $(this).html('<div class="tooltip-inner">' + '<span>' + value + '</span>' + '</div>');
        });
    });
})(window.jQuery);